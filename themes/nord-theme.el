...
(let* ((class '((class color) (min-colors 89)))
       ...
       (nord2 (if (display-graphic-p) "#434C5E" "red"))
       (nord3 (if (display-graphic-p) "#4C566A" "green"))
       (nord4 (if (display-graphic-p) "#D8DEE9" "yellow"))
       (nord5 (if (display-graphic-p) "#E5E9F0" "blue"))
       (nord6 (if (display-graphic-p) "#ECEFF4" "magenta"))
       (nord7 (if (display-graphic-p) "#8FBCBB" "cyan"))
       (nord8 (if (display-graphic-p) "#88C0D0" "white"))
       (nord9 (if (display-graphic-p) "#81A1C1" "brightblack"))
       (nord10 (if (display-graphic-p) "#5E81AC" "brightred"))
       (nord11 (if (display-graphic-p) "#BF616A" "brightgreen"))
       (nord12 (if (display-graphic-p) "#D08770" "brightyellow"))
       (nord13 (if (display-graphic-p) "#EBCB8B" "brightblue"))
       (nord14 (if (display-graphic-p) "#A3BE8C" "brightmagenta"))
       (nord15 (if (display-graphic-p) "#B48EAD" "brightcyan"))
       ...
       (nord-method (if (display-graphic-p) "#88C0D0" "white"))
       (nord-keyword (if (display-graphic-p) "#81A1C1" "brightblack"))
       (nord-numeric (if (display-graphic-p) "#B48EAD" "brightcyan"))
       (nord-operator (if (display-graphic-p) "#81A1C1" "brightblack"))
       (nord-preprocessor (if (display-graphic-p) "#5E81AC" "brightred"))
       (nord-punctuation (if (display-graphic-p) "#D8DEE9" "yellow"))
       (nord-regexp (if (display-graphic-p) "#EBCB8B" "brightblue"))
       (nord-string (if (display-graphic-p) "#A3BE8C" "brightmagenta"))
       (nord-tag (if (display-graphic-p) "#81A1C1" "brightblack"))
       (nord-variable (if (display-graphic-p) "#D8DEE9" "yellow"))
       ...
       (nord-region-highlight-background (if
                                           ...
                                           (if (string= nord-region-highlight "snowstorm") "#D8DEE9" nord2)))
       (nord-uniform-mode-lines-background (if nord-uniform-mode-lines "#4C566A" nord1)))
...
;;;; +------------+
  (custom-theme-set-faces
   ...
   ;; > ediff
   `(ediff-current-diff-A ((,class (:foreground ,nord6 :background ,nord11))))
   `(ediff-current-diff-Ancestor ((,class (:foreground ,nord6 :background ,nord11))))
   `(ediff-current-diff-B ((,class (:foreground ,nord6 :background ,nord12))))
   `(ediff-current-diff-C ((,class (:foreground ,nord6 :background ,nord10))))
   ...
   `(ediff-fine-diff-A ((,class (:foreground ,nord6 :background ,nord14 :weight normal))))
   `(ediff-fine-diff-Ancestor ((,class (:foreground ,nord6 :background ,nord14 weight normal))))
   `(ediff-fine-diff-B ((,class (:foreground ,nord6 :background ,nord15 :weight normal))))
   `(ediff-fine-diff-C ((,class (:foreground ,nord6 :background ,nord13 :weight normal))))
   ...
   `(diff-header ((,class (:foreground ,nord9 :weight normal))))
   ...
   `(buffer-menu-buffer ((,class (:foreground ,nord4 :weight normal))))
   ...
   `(completions-common-part ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(custom-group-tag ((,class (:foreground ,nord8 :weight normal))))
   `(custom-group-tag-1 ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(minibuffer-prompt ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(outline-1 ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(package-help-section-name ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(package-status-held ((,class (:foreground ,nord4 :weight normal))))
   `(package-status-new ((,class (:foreground ,nord14))))
   `(package-status-incompat ((,class (:foreground ,nord11))))
   `(package-status-installed ((,class (:foreground ,nord7 :weight normal))))
   ...
   `(font-latex-sectioning-0-face ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(elixir-atom-face ((,class (:foreground ,nord4 :weight normal))))
   ...
   `(jdee-db-active-breakpoint-face ((,class (:background ,nord2 :weight normal))))
   `(jdee-bug-breakpoint-cursor ((,class (:background ,nord2))))
   `(jdee-db-requested-breakpoint-face ((,class (:foreground ,nord13 :background ,nord2 :weight normal))))
   `(jdee-db-spec-breakpoint-face ((,class (:foreground ,nord14 :background ,nord2 :weight normal))))
   ...
   `(company-tooltip-selection ((,class (:background ,nord3 :weight normal))))
   ...
   `(flycheck-fringe-info ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(helm-candidate-number ((,class (:foreground ,nord4 :weight normal))))
   `(helm-candidate-number-suspended ((,class (:foreground ,nord4))))
   `(helm-ff-directory ((,class (:foreground ,nord9 :weight normal))))
   `(helm-ff-dirs ((,class (:foreground ,nord9))))
   `(helm-ff-dotted-director ((,class (:foreground ,nord9 :underline t))))
   `(helm-ff-dotted-symlink-director ((,class (:foreground ,nord7 :weight normal))))
   ...
   `(helm-lisp-completion-info ((,class (:foreground ,nord4 :weight normal))))
   ...
   ;; > Magit
   `(magit-branch ((,class (:foreground ,nord7 :weight normal))))
   ...
   `(neo-expand-btn-face ((,class (:foreground ,nord6 :normal t))))
   `(neo-file-link-face ((,class (:foreground ,nord4))))
   `(neo-root-dir-face ((,class (:foreground ,nord7 :weight normal))))
   ...
   ;; > Org
   `(org-level-1 ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(org-document-info-keyword ((,class (:foreground ,nord3 :weight normal))))
   `(org-document-title ((,class (:foreground ,nord8 :weight normal))))
   ...
   `(ido-first-match ((,class (:foreground ,nord8 :weight normal))))
   `(ido-subdir ((,class (:foreground ,nord9))))
   `(org-quote ((,class (:inherit org-block :slant italic))))
   `(org-verse ((,class (:inherit org-block :slant italic))))
   `(org-agenda-date-weekend ((,class (:foreground ,nord9))))
   `(org-agenda-date-today ((,class (:foreground ,nord8 :weight normal))))
   `(org-agenda-done ((,class (:foreground ,nord14))))
